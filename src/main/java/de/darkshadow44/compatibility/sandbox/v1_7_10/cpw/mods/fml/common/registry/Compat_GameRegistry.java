...
import de.darkshadow44.compatibility.sandbox.v1_7_10.cpw.mods.fml.common.Wrapper_WorldGenerator;
...
public class Compat_GameRegistry {
	public static void Compat_registerWorldGenerator(Compat_IWorldGenerator generator, int modGenerationWeight) {
		GameRegistry.registerWorldGenerator(new Wrapper_WorldGenerator(generator), modGenerationWeight);
	}
}
