...
public class EnumHelper {
	...
	private static Class[][] ctrs = { { EnumAction.class },
			...
			{ EnumCreatureType.class, Class.class, int.class, Material.class, boolean.class }, { EnumDoor.class },
			{ EnumEnchantmentType.class }, { EnumMobType.class }, { EnumMovingObjectType.class },
			{ EnumSkyBlock.class, int.class }, { EnumStatus.class },
	...
	public static EnumAction addAction(String name) {
		...
		return addEnum(decompiledFlags[0], EnumAction.class, name, new Class[] {}, new Object[] {});
	}
	...
	public static EnumCreatureAttribute addCreatureAttribute(String name) {
		...
		return addEnum(decompiledFlags[3], EnumCreatureAttribute.class, name, new Class[] {}, new Object[] {});
	}
	...
	public static EnumDoor addDoor(String name) {
		...
		return addEnum(decompiledFlags[5], EnumDoor.class, name, new Class[] {}, new Object[] {});
	}
	...
	public static EnumEnchantmentType addEnchantmentType(String name) {
		...
		return addEnum(decompiledFlags[6], EnumEnchantmentType.class, name, new Class[] {}, new Object[] {});
	}
	...
	public static EnumMobType addMobType(String name) {
		...
		return addEnum(decompiledFlags[7], EnumMobType.class, name, new Class[] {}, new Object[] {});
	}
	...
	public static EnumMovingObjectType addMovingObjectType(String name) {
		...
		return addEnum(decompiledFlags[8], EnumMovingObjectType.class, name, new Class[] {}, new Object[] {});
	}
	...
	public static EnumSkyBlock addSkyBlock(String name, int lightValue) {
		...
		return addEnum(decompiledFlags[9], EnumSkyBlock.class, name, new Class[] { int.class },
	...
	public static EnumStatus addStatus(String name) {
		...
		return addEnum(decompiledFlags[10], EnumStatus.class, name, new Class[] {}, new Object[] {});
	}
	...
	private static Object getConstructorAccessor(boolean decompiled, Class<?> enumClass,
	...
	private static <T extends Enum<?>> T makeEnum(boolean decompiled, Class<T> enumClass, String value, int ordinal,
		...
		return enumClass.cast(newInstance.invoke(getConstructorAccessor(decompiled, enumClass, additionalTypes),
				new Object[] { parms }));
	}
