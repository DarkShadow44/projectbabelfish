...
public class Block {
	...
	private static StepSound soundClothFootstep = new StepSound();
	private static StepSound soundPowderFootstep = new StepSound();
    ...
    private Block setTickRandomly(boolean b) {
		return this;
	}
	...
	protected Block setBlockName(String string) {
		return this;
	}
	...
	protected Block setStepSound(StepSound par0) {
		return this;
	}
	...
	public Block(int par1, int par2, Material ice2, boolean b) {
	}

	public Block(int par1, int par2, boolean b) {
	}
